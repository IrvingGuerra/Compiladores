...
{      /* if con else */
            char buffer1[200], buffer2[200], buffer3[200];
                     /*itoa($1,buffer,10);*/
                     sprintf(buffer1, "%d", yyvsp[-4].inst-prog);
                     sprintf(buffer2, "%d", yyvsp[-1].inst-prog);
                     sprintf(buffer3, "%d", yyvsp[0].inst-prog);
...
{  /*puts("NUMBER"); */
                 printf("NUMBER = (%s)\n", yyvsp[0].sym->nombre);
                 yyval.inst = code2(strdup("constpush"), (Inst)(yyvsp[0].sym->nombre)); 
...
{   /*puts("yacc ARG");*/
                     char buffer[200];
                     /*itoa($1,buffer,10);*/
                     sprintf(buffer, "%d", yyvsp[0].narg);
                     defnonly("$"); 
                  yyval.inst = code2(strdup("arg"), (Inst)strdup(buffer)); 
